...
- cmremote: Add git remote for AICP Gerrit Review
- cmgerrit: A Git wrapper that fetches/pushes patch from/to AICP Gerrit Review
...
# Add completions
check_bash_version && {
    dirs="sdk/bash_completion vendor/aicp/bash_completion"
    for dir in $dirs; do
    if [ -d ${dir} ]; then
